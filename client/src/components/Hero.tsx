      ...
      <div className="container mx-auto relative z-10">
        <header className="max-w-2xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white font-heading leading-tight mb-4 animate-fade-in">
            Smarter Meals. Healthier Lives.<br />Less Stress.
          </h1>
          ...
          <p className="text-lg md:text-xl text-white opacity-95 mb-8 animate-slide-in" style={{animationDelay: "0.2s"}}>
            Join the beta. Let SavviWell help carry the load.
          </p>
          <Button 
            onClick={onWaitlistClick}
            size="lg"
            className="bg-primary hover:bg-primary/70 text-white font-bold shadow-lg transition-all transform hover:scale-105 animate-slide-in rounded-full px-8 py-4 text-lg md:text-xl"
